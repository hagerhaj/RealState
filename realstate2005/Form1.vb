...
Public Class Form1
    ...
    Private Sub proindex_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles proindex.LostFocus
        Try
            Dim dr As SqlDataReader
            Dim Region1 As String = "الاقليم الجنوبي"
            Dim sql As String = "select * from Realestatedata Where proindex='" & Me.proindex.Text & "' And  RegionName = '" & Region1 & "' "
    ...
    Private Sub proindex_TextChanged(sender As System.Object, e As System.EventArgs) Handles proindex.TextChanged
